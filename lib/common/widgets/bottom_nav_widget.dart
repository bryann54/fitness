...
import 'package:fitness/common/res/l10n.dart';
        ...
        child: FlashyTabBar(
          ...
          items: [
            FlashyTabBarItem(
              ...
              title: Text(
                AppLocalizations.getString(context, 'workouts'),
            ...
            FlashyTabBarItem(
              ...
              title: Text(
                AppLocalizations.getString(context, 'meal plans'),
                style: GoogleFonts.poppins(
                  fontSize: 12,
                  fontWeight: FontWeight.w500,
                ),
            ...
            FlashyTabBarItem(
              ...
              title: Text(
                AppLocalizations.getString(context, 'Community'),
                style: GoogleFonts.poppins(
                  fontSize: 12,
                  fontWeight: FontWeight.w500,
                ),
